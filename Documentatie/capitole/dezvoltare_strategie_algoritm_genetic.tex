...
-- sa adaug poate o anexa care sa ateste acest lucru??  
...
Figura \ref{fig:probabilitati_selectie_ruleta} reprezinta un exemplu de ruletă divizată în patru sectoare de arii proporționale cu probabilitățile de selecție\footnote{Adaptare după Cursul de \textit{Calcul neuronal și calcul evolutiv}, Prof. dr. Daniela Zaharie, Facultatea de Matematică si Informatică, Universitatea de Vest din Timişoara\cite{curs_daniela_zaharie}.}.
...
Rezultatul din figura \ref{fig:invartire_ruleta} poate fi interpretat drept selectarea individului care corespunde categoriei etichetate cu verde (elementul numarul 4, ce a avut o probabilitate de selectie de 40\%).
